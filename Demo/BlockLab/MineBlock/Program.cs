...
namespace MineBlock
{
    static class Program
    {
        class GameState
        {
            ...
            public void UpdatePosition(float elapsedTimeMS, Camera camera, World world)
            {
                ...
                // vertical
                var pos = new Int3((int)camera.Pos.X, (int)camera.Pos.Y, (int)(camera.Pos.Z));
                while (!world.HasBlock(pos) && pos.Z >= 0)
                {
                    --pos.Z;
                }
                ground = (float)pos.Z + Block.HALF_SIZE;
                if (altitude > ground || (altitude == ground && upVelocity != 0.0f))
                {
        ...
        static void Main()
        {
            ...
            game.Start(
                ...
                GameLogic: (float elapsedTimeMS) =>
                {
                    ...
                    gameState.UpdatePosition(elapsedTimeMS, camera, world);
